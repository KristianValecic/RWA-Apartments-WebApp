         ...
         <fieldset class="container p-4">
             <legend>Login</legend>
              ...
              <div class="mb-3">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtPassword" Display="Dynamic" ForeColor="Red">* You must enter a password</asp:RequiredFieldValidator>
              </div>
